...
export class ProductService {
  ...
  getProducts() {
    return this.http.get<InventoryResponse>(`${urlProducts}`, this.authService.headers);
  }
  getProduct(id: string) {
    return this.http.get<InventoryResponse>(`${urlProducts}/${id}`, this.authService.headers);
  }
  ...
  // AUDITORIA: Obtener productos pendientes
  getPendingVerificationProducts(companyId: string) {
    return this.http.get<any>(`${urlProducts}/audit/pending/${companyId}`, this.authService.headers);
  }

  // AUDITORIA: Formalizar
  formalizeProduct(id: string, payload: any) {
    return this.http.post<any>(`${urlProducts}/audit/formalize/${id}`, payload, this.authService.headers);
  }

  // AUDITORIA: Fusionar
  mergeProduct(sourceId: string, targetId: string) {
    return this.http.post<any>(`${urlProducts}/audit/merge/${sourceId}`, { targetId }, this.authService.headers);
  }
}
